            ...
            if eachRef!='Unaligned':
                if clusterDict[eachCluster][eachRef].forAlignment==0:
                    if len(clusterDict[eachCluster][eachRef].listSeqIndices)>1:
                        print 'What??!'
                    if onlyDiGReq[clusterDict[eachCluster][eachRef].listSeqIndices[0]]==True or onlyDiCReq[clusterDict[eachCluster][eachRef].listSeqIndices[0]]==True: #assuming that there is only one sequence per forAlignment=0 subreference
