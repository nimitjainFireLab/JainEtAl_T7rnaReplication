...
alignmentMetrics['testDict']=sys.argv[2]
alignmentMetrics['collapsedEndsClusterDict']=sys.argv[1]
...
with open(sampleName+'_numberStoreDict_alignmentNoTemplateThreePrimeBases.pckl','wb') as f:
